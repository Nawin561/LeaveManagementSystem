...
<script src="/js/viewAllDepartment.js"></script>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page">
			<div id="content" 	style="min-height: 400px; background-color: white; width: 20%; float: left;">
				<ul class="style2">
					...
					<li>
						<h3>
							<form name="form4" method="POST"
								...
								<input type="submit" id="click1" name="click1" class="btn btn-default "
					...
					<li>
						<h3>
							<form name="form4" method="POST"
								...
								<input type="submit" id="click1" name="click1" class="btn btn-default "
									value="View All Department">
							</form>
						</h3>
					</li>
				</ul>
			</div>
			<div id="sidebar" 	style="min-height: 350px; background-color: whie; width: 60%; float: left;">
				<div id="tbox1">
					<!-- 					<form name="form1" method="POST" -->
					<!-- 						action="/DepartmentOperation/deleteDepartment.htm"> -->
					<h3>
