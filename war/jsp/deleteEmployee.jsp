	...
	<div id="wrapper">
		...
		<div id="page">
			...
			<div id="sidebar"
				...
				<div id="tbox1">
					...
					<div class="table" style="width: 600px;">
						<table id="dataTable" class="table">
							...
							%>
							<tr>
								<td><input type="checkbox" id=<%=category.getEmail()%>
									value=<%=category.getEmail()%> name="rowrecord" /><%=category.getEmail()%></td>
					...
					onclick="ajaxDeleteSingleEmployeeFunction('dataTable','<%=category.getEmail()%>')" class="btn btn-danger " /></td>
								<td></td>
							</tr>
							<%
								i = i + 1;
				...
				<input type="button" value="Delete Selected Employee(s)"
